...
#define PWRHoldRlyON        GpioDataRegs.GPASET.bit.GPIO21=1
#define PWRHoldRlyOFF       GpioDataRegs.GPACLEAR.bit.GPIO21=1
...
// TODOS : [완료] 26.06.23 Product_Type : 양산 (1), 시험(0)
#define     Product_Type                       1   // 
// TODOS : [완료] 26.06.04 Product_Version 26 -> 과전류 보호 개정(OcTime Fault 삭제, 순시 500A, 알람 400A)
// TODOS : [완료] 26.06.23 Product_Version 27 변경함 
#define     Product_Version                    27 
...
#define     C_Bat80VOVCellVoltageFaultDelay               1
#define     C_Bat80VUDCellVoltageFaultDelay               1
#define     C_Bat80VDIVCellVoltageFaultDelay              1
#define     C_Bat80VOVCellTemperatureFaultDelay           0
#define     C_Bat80VUDCellTemperatureFaultDelay           0
#define     C_Bat80VDIVCellTemperatureFaultDelay          20
